...
class FORTE_MODE: public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_MODE)
...
public:
  FORTE_MODE(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
      CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, nullptr, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_MODE() = default;
};
