...
const CStringDictionary::TStringId FORTE_SmartIX::scm_anDataInputNames[] = {g_nStringIdMODE, g_nStringIdOPC_Variable, g_nStringIdOPC_Address, g_nStringIdIO};

const CStringDictionary::TStringId FORTE_SmartIX::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdWSTRING, g_nStringIdWSTRING, g_nStringIdSTRING};
...
const TDataIOID FORTE_SmartIX::scm_anEIWith[] = {0, 1, 3, 2, 255, 0, 1, 3, 2, 255};
const TForteInt16 FORTE_SmartIX::scm_anEIWithIndexes[] = {0, 5};
...
const SCFB_FBConnectionData FORTE_SmartIX::scm_astEventConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0, g_nStringIdINITO), 4, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdINITO), -1},
};
