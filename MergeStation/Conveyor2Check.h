...
#ifndef _CONVEYOR2CHECK_H_
#define _CONVEYOR2CHECK_H_
...
class FORTE_Conveyor2Check: public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_Conveyor2Check)
...
public:
  FORTE_Conveyor2Check(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
      CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, nullptr, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_Conveyor2Check() = default;
};

#endif // _CONVEYOR2CHECK_H_
