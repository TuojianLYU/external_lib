...
const SCFB_FBFannedOutConnectionData FORTE_OpcuaParamGen::scm_astFannedOutEventConnections[] = {
};
...
const SCFB_FBFannedOutConnectionData FORTE_OpcuaParamGen::scm_astFannedOutDataConnections[] = {
};
